...
warmup_sup_training_epochs = 15 
lr_config = dict(
    policy='step',
    warmup='linear',
    warmup_iters=500,
    warmup_ratio=1.0 / 3,
    step=[27+warmup_sup_training_epochs, 33+warmup_sup_training_epochs])
runner = dict(type='EpochBasedRunner', max_epochs=36+warmup_sup_training_epochs)
...
custom_hooks = [
    ...
    dict(type="MeanTeacher_DualTeacehr", momentum=0.999, interval=1, warm_up=0) 
]
