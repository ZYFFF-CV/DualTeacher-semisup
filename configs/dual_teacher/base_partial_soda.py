...
work_dir = "/root/autodl-tmp/workdirs/${cfg_name}/${percent}"
...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            type="SODAADataset",
            ann_file=data_root + 'semisup-trainval/labelTxt_${percent}p_labeled',
        ...
        unsup=dict(
            type="SODAADataset",       
            ann_file=data_root + 'semisup-trainval/labelTxt_${percent}p_unlabeled',
            img_prefix=data_root + 'trainval/Images',
