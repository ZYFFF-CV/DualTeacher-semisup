...
"""
v1
1.	supervised训练rotate fcos
2.	若干的epoch后,将现有rotate fcos(student)作为teacher,继续监督训练,暂定5个epoch
v2
若干的epoch后,将现有rotate fcos(student)作为teacher, 两个teacher 做bbox ema继续监督训练
"""
