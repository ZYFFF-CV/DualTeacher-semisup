"""
Rotated FCOS as in 'mmrotate/mmrotate/models/dense_heads
...
from ssoddota.utils import log_every_n, log_multicalss_loss_kde_fgbg
import logging
...
class RotatedFCOSHead_plain(RotatedAnchorFreeHead):
    ...
    def loss(self,
        ...
        log_multicalss_loss_kde_fgbg( scores = flatten_cls_scores,
