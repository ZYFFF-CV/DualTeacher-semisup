...
from mmrotate.models.dense_heads.utils import levels_to_images
...
class OrientedRepPointsHead_st(BaseDenseHead):
    ...
    As in the semi-supervised learning, there exists unlabeled images without annotations.
    This will impede the training. Thus, folllowing the RFOCS head, when no annotation, 
    some steps will be omited
    ...
    def __init__(self,
                 ...
                 init_cfg=dict(
                     ...
                     override=dict(
                         ...
                         bias_prob=0.01)),
                 **kwargs):
        super(OrientedRepPointsHead_st, self).__init__(init_cfg)
