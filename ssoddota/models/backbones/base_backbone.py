...
# Copied from MMYolo, support mmdet 2.x
...
class BaseBackbone(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
                 arch_setting,#: list,
                 deepen_factor=1.0,#: float = 1.0,
                 widen_factor=1.0,#: float = 1.0,
                 input_channels=3,#: int = 3,
                 out_indices= (2, 3, 4),#: Sequence[int] = (2, 3, 4),
                 frozen_stages=-1,#: int = -1,
                 plugins= None, #: Union[dict, List[dict]] = None,
                 norm_cfg= None, #: ConfigType = None,
                 act_cfg= None, #: ConfigType = None,
                 norm_eval=False,#: bool = False,
                 init_cfg= None, #: OptMultiConfig = None
                 ):
