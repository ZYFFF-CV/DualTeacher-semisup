...
from mmrotate.datasets.builder import ROTATED_DATASETS as DATASETS
...
import cv2
"""
1.Still too slow: use dota 'evaluation' to get a quick result
2.bug fixed: data_info['id'] = f['id']
...
class SODAADataset(CustomDataset):
    ...
    def __init__(self,
        ...
        super(SODAADataset, self).__init__(ann_file, **kwargs)
        # self.ori_infos = self.load_ori_annotations(ori_ann_file)
        self.ori_data_infos = self.load_ori_annotations(ann_file)
        ...
        for ann_file in ann_files:
            ...
            for ann in annotations:
                ...
                try:
                    ...
                    continue
                label = int(ann["cat_id"]) #int(ann['category_id'])  # 0-index
    ...
    def evaluat_sodaa(self,
        ...
        Args:
            ...
            nproc (int): Processes used for computing TP and FP.
                Default: 4.
        """
        merged_results = self.merge_det(results, with_merge=False, nproc=nproc)
